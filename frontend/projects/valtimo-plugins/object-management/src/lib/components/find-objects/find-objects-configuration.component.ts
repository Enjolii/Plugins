...
@Component({
    selector: 'valtimo-find-objects-configuration',
...
export class FindObjectsConfigurationComponent
    ...
    private handleValid(formValue: FindObjectsConfig): void {
        const valid = !!(formValue.objectManagementConfigurationId && formValue.searchString && formValue.pagesize && formValue.pagenumber && formValue.listOfObjectsProcessVariableName);
